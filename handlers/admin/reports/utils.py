...
# =========================================================
def build_report_text(report: dict, mode: str = REPORT_MODE_SHORT, show_photos: bool = True):
...
def get_report_text(date_str: str, mode: str, show_photos: bool):
...
def get_taxi_photo_overview(date_str: str) -> dict:
    ...
    for user_data in taxi_data:
        ...
        for exp in user_data.get("expenses", []):
            # Поддержка обоих вариантов ключей из БД
