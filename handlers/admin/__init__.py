...
from .constants import (
    ...
    ADMIN_EDIT_LOCATION, ADMIN_EDIT_CATEGORY,
...
def register_admin_states(states: dict):
    ...
    from .constants import (
        CB_SHIFTS, CB_CALENDAR, CB_EDIT, CB_PREV_MONTH, CB_NEXT_MONTH,
        CB_DAY_PREFIX, CB_TO_CALENDAR, CB_TO_EDIT, CB_TO_CATEGORIES,
        CB_TO_ITEMS, CB_LOC_PREFIX, CB_CAT_PREFIX, CB_PAGE_PREFIX,
        CB_ITEM_PREFIX, CB_EDIT_ITEM_PREFIX, CB_DELETE_ITEM_PREFIX,
        CB_CONFIRM_DELETE_PREFIX, CB_ADD, CB_ADD_DAY_PREFIX, CB_HOME,
    )

    states[ADMIN_MAIN] = admin_state(f"^{CB_SHIFTS}$|^{CB_CALENDAR}$|^{CB_EDIT}$|^{CB_HOME}$")
    states[ADMIN_SHIFTS] = admin_state(f"^{CB_HOME}$|^{CB_CALENDAR}$")
    ...
    states[ADMIN_EDIT_ITEMS] = admin_state(
        f"^{CB_ITEM_PREFIX}.*|^{CB_PAGE_PREFIX}.*|^{CB_ADD}$|^{CB_TO_CATEGORIES}$|^{CB_HOME}$"
    )
    ...
    states[ADMIN_DELETE_CONFIRM] = admin_state(
        f"^{CB_CONFIRM_DELETE_PREFIX}.*|^{CB_ITEM_PREFIX}.*"
    )
