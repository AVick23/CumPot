...
PROGRESS_VIEW = 5
CATEGORY_SELECT = 6
ITEM_DETAIL = 7          # новое состояние для детального просмотра задачи
...
CB_ITEM_VIEW = "item_view_"       # просмотр задачи
CB_ITEM_TOGGLE = "item_toggle_"   # переключение статуса (выполнить/отменить)
CB_BACK_MAIN = "back_main"
CB_CATEGORY = "category_"
CB_BACK_CATEGORIES = "back_categories"
CB_BACK_TO_CATEGORIES = "back_to_categories"  # возврат к категориям из деталей
